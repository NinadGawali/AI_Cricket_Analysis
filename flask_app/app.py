...
# Configuration
DB_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "cricket_matches.db")
    ...
    try:
        query = """
            SELECT 
                ...
                ROUND(SUM(b.runs_off_bat) * 100.0 / COUNT(b.ball_id), 2) as strike_rate,
...
if __name__ == '__main__':
    # threaded + no reloader improves SSE stability in dev
